...
search_bm25 = Bm25Search(commands, number_entries_to_return=10)
...
with dpg.window(
    label="PythonSearch", no_title_bar=True, no_bring_to_front_on_focus=True
):
    dpg.add_input_text(
        label="query", source="query", width=800, show=True, enabled=True
    )
